...
const s_formId = '1FAIpQLSf6UUA1ewD7WK8qzZryKw_7pQyBSnLQ72pw88vpGZoN78cs-Q';
...
const s_sheetId = '1-gzLToBcQa8T-pLUVRZAwgOvBfBTLOGKPmxpTRoJ1D0';
...
let v_pagePath = window.location.search;
...
function createComment(data) {
    ...
    if (data.Moderated == false) {
        comment.classList = "c-unmoderated "
    }
...
title.textContent = currentYear + ' ' + title.textContent;

target = document.getElementById("other_dates");
